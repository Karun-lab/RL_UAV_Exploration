...
parser.add_argument("--log_dir",    type=str,  default="logs/skrl/iris_ego")
...
from rl_WorkSpace.rl_envs.iris_ego_env import IrisEgoEnvCfg
from rl_WorkSpace.rl_envs.iris_ego_agent import get_agent
...
def main():
    ...
    env_raw = gym.make("Isaac-Iris-Ego-v0", cfg=cfg)
