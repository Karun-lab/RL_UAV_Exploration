...
parser = argparse.ArgumentParser(description="Train Iris with ICM and Map.")
...
from rl_WorkSpace.rl_envs.iris_icm_map_env import IrisICMOfficeEnvCfg
from rl_WorkSpace.agents.iris_icm_map_agent import get_agent

cfg = IrisICMOfficeEnvCfg()
cfg.scene.num_envs = args_cli.num_envs

env = gym.make("Isaac-Iris-ICM-v2", cfg=cfg)
env = wrap_env(env)
...
trainer_cfg = {"timesteps": 250_000, "headless": True}
