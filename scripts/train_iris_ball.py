...
parser = argparse.ArgumentParser(description="Train Iris ball tracking with skrl.")
...
from rl_WorkSpace.rl_envs.iris_ball_env_cfg import IrisBallEnvCfg
from rl_WorkSpace.rl_envs.iris_ball_agent import get_agent

cfg = IrisBallEnvCfg()
cfg.scene.num_envs = args_cli.num_envs

env = gym.make("Isaac-Iris-Ball-v0", cfg=cfg)
env = wrap_env(env)
